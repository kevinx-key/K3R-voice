...
Name "倾听输入法 ${WEASEL_VERSION}"

; The file to write
OutFile "archives\weasel-${PRODUCT_VERSION}-installer.exe"

VIProductVersion "${WEASEL_VERSION}.${WEASEL_BUILD}"
VIAddVersionKey /LANG=2052 "ProductName" "倾听输入法"
VIAddVersionKey /LANG=2052 "Comments" "Powered by RIME | 中州韻輸入法引擎"
VIAddVersionKey /LANG=2052 "CompanyName" "K3R"
VIAddVersionKey /LANG=2052 "LegalCopyright" "基于 rime/weasel 0.17.4 (GPLv3)"
VIAddVersionKey /LANG=2052 "FileDescription" "倾听输入法"
...
LangString DISPLAYNAME ${LANG_TRADCHINESE} "傾聽輸入法"
LangString LNKFORMANUAL ${LANG_TRADCHINESE} "【傾聽輸入法】說明書"
LangString LNKFORSETTING ${LANG_TRADCHINESE} "【傾聽輸入法】輸入法設定"
LangString LNKFORDICT ${LANG_TRADCHINESE} "【傾聽輸入法】用戶詞典管理"
LangString LNKFORSYNC ${LANG_TRADCHINESE} "【傾聽輸入法】用戶資料同步"
LangString LNKFORDEPLOY ${LANG_TRADCHINESE} "【傾聽輸入法】重新部署"
LangString LNKFORSERVER ${LANG_TRADCHINESE} "傾聽輸入法算法服務"
LangString LNKFORUSERFOLDER ${LANG_TRADCHINESE} "【傾聽輸入法】用戶文件夾"
LangString LNKFORAPPFOLDER ${LANG_TRADCHINESE} "【傾聽輸入法】程序文件夾"
LangString LNKFORUPDATER ${LANG_TRADCHINESE} "【傾聽輸入法】檢查新版本"
LangString LNKFORSETUP ${LANG_TRADCHINESE} "【傾聽輸入法】安裝選項"
LangString LNKFORUNINSTALL ${LANG_TRADCHINESE} "卸載傾聽輸入法"
LangString CONFIRMATION ${LANG_TRADCHINESE} "安裝前，請先卸載舊版本的傾聽輸入法。$\n$\n按下「確定」移除舊版本，按下「取消」放棄本次安裝。"
...
LangString DISPLAYNAME ${LANG_SIMPCHINESE} "倾听输入法"
LangString LNKFORMANUAL ${LANG_SIMPCHINESE} "【倾听输入法】说明书"
LangString LNKFORSETTING ${LANG_SIMPCHINESE} "【倾听输入法】输入法设定"
LangString LNKFORDICT ${LANG_SIMPCHINESE} "【倾听输入法】用户词典管理"
LangString LNKFORSYNC ${LANG_SIMPCHINESE} "【倾听输入法】用户资料同步"
LangString LNKFORDEPLOY ${LANG_SIMPCHINESE} "【倾听输入法】重新部署"
LangString LNKFORSERVER ${LANG_SIMPCHINESE} "倾听输入法算法服务"
LangString LNKFORUSERFOLDER ${LANG_SIMPCHINESE} "【倾听输入法】用户文件夹"
LangString LNKFORAPPFOLDER ${LANG_SIMPCHINESE} "【倾听输入法】程序文件夹"
LangString LNKFORUPDATER ${LANG_SIMPCHINESE} "【倾听输入法】检查新版本"
LangString LNKFORSETUP ${LANG_SIMPCHINESE} "【倾听输入法】安装选项"
LangString LNKFORUNINSTALL ${LANG_SIMPCHINESE} "卸载倾听输入法"
LangString CONFIRMATION ${LANG_SIMPCHINESE} '安装前，请先卸载旧版本的倾听输入法。$\n$\n点击 "确定" 移除旧版本，或点击 "取消" 放弃本次安装。'
...
LangString DISPLAYNAME ${LANG_ENGLISH} "Listen"
LangString LNKFORMANUAL ${LANG_ENGLISH} "Listen Manual"
LangString LNKFORSETTING ${LANG_ENGLISH} "Listen Settings"
LangString LNKFORDICT ${LANG_ENGLISH} "Listen Dictionary Manager"
LangString LNKFORSYNC ${LANG_ENGLISH} "Listen Sync User Profile"
LangString LNKFORDEPLOY ${LANG_ENGLISH} "Listen Deploy"
LangString LNKFORSERVER ${LANG_ENGLISH} "Listen Server"
LangString LNKFORUSERFOLDER ${LANG_ENGLISH} "Listen User Folder"
LangString LNKFORAPPFOLDER ${LANG_ENGLISH} "Listen App Folder"
LangString LNKFORUPDATER ${LANG_ENGLISH} "Listen Check for Updates"
LangString LNKFORSETUP ${LANG_ENGLISH} "Listen Installation Preference"
LangString LNKFORUNINSTALL ${LANG_ENGLISH} "Uninstall Listen"
LangString CONFIRMATION ${LANG_ENGLISH} "Before installation, please uninstall the old version of Listen.$\n$\nPress 'OK' to remove the old version, or 'Cancel' to abort installation."
...
program_files:
  ...
  WriteRegStr HKLM "${REG_UNINST_KEY}" "Publisher" "K3R"
